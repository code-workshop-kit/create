...
class Generator extends _Generator.default {
  constructor() {
    super();
    this.generatorName = 'code-workshop-kit';
  }
  ...
  async end() {
    ...
    if (this.wantsRecreateInfo) {
      ...
      console.log('');
      console.log('To go into the scaffolded directory, run:');
      console.log(chalk.cyanBright(`  cd ${this.templateData.name}`));
      console.log('');
      console.log('Add some participants to your participants array in cwk.config.js!');
      console.log('');
      console.log('Then run:');
      console.log(chalk.cyanBright(`  npm install`));
      console.log(chalk.cyanBright('  npm run scaffold'));
